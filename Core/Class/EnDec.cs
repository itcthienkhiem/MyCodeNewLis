...
public class EnDec
{
    private class KeyDetails
    {
        ...
        public bool Expires
        {
            get { return m_blnExpires; }
            set { m_blnExpires = value; }
        }

        public bool IsValid
        {
            get { return m_blnIsValid; }
            set { m_blnIsValid = value; }
        }

        public DateTime DateValidThrough
        {
            get { return m_dteDateValidThrough; }
            set { m_dteDateValidThrough = value; }
        }

        public DateTime DateCreated
        {
            get { return m_dteDateCreated; }
            set { m_dteDateCreated = value; }
        }
    }
    ...
    internal static string DecryptMD5(string cipherText, string p_strSaltValue)
    {
        ...
        try
        {
            ...
            password = new System.Security.Cryptography.PasswordDeriveBytes(m_strPassPhrase, saltValueBytes,
                m_strHashAlgorithm, m_strPasswordIterations);
            ...
            cryptoStream = new System.Security.Cryptography.CryptoStream(memoryStream, decryptor,

...
Public Module globalModule
    ...
    Public gv_sHotPhone As String = Utilities.GetFieldValue("sys_ManagementUnit", "sHotPhone", "1=1")
    ...
    Public KTBARCODE As String = Utilities.GetKTBarcode
    'Biến lưu connection String 
    Public Cnns$ = Utilities.GetDBConnectionString
    ...
    Public gv_showTitleReport As String = SysPara.ShowHideReportHeader
    ...
    End Function
    'Public Function GetReportTypePrintAll() As Integer
    '    Return lablinkhelper.Utilities.GetReportTypePrintAll
    'End Function
    Public Function GetDigibarcode() As Integer
        Return Utilities.BarcodeDigit
    End Function

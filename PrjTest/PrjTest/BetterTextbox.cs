...
namespace PrjTest
{
    class BetterTextbox : TextBox
    {
        ...
        private List<Frm_TraTu.clstentienganh> dstienganh;
        ...
        //}
        public void TiengAnh(List<Frm_TraTu.clstentienganh> dstienganh)
        {
            this.dstienganh = dstienganh;
        }
        ...
        private void This_TextChanged(object sender, EventArgs e)
        {
            ...
            if (StrToSearch.Length > 0)
            {
                if (dstienganh != null)
                {
                    foreach (var v in dstienganh)
                    {
                        if (UnUnicodeText(v.tentienganh).Contains(StrToSearch))
                        {
                            lb1.Items.Add(v.tentienganh);
                        }
                    }
                    ShowLisBox();
                }

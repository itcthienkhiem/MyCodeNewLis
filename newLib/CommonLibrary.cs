...
//if (dt.Columns.Contains(TDmucKho.Columns.MaKho)) dr[TDmucKho.Columns.MaKho] = "";
        ...
        public static System.DateTime getSysDate()
        {
            try
            {
                DateTime dateTime = new InlineQuery().ExecuteScalar<DateTime>("select getdate()");
                globalVariables.SysDate = dateTime;
               // globalVariables.v_dtGetDateTime = dateTime;
                return dateTime;
